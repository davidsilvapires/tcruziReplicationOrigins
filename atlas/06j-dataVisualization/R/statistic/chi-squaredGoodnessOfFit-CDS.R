...
# Orc1Cdc6 and replication origins within the genomic CDS of Trypanosoma cruzi. As the data  #
# exhibit a non-parametric nature and follow a standard distribution of features, we utilized the #
# chi-square goodness-of-fit test for analysis.                                                   #
#                                                                                                 #
...
chisq <- chisq.test(table, p= c(0.0078, 0.0006, 0.0031, 0.0630, 0.0028, 0.0037, 0.0149, 0.4813, 0.0013, 0.0356, 0.0129 , 0.0014, 0.0306, 0.0665, 0.0018, 0.2727), simulate.p.value = TRUE,B = 1000)
chisq

chisq <- chisq.test(table, p= c(0.0078, 0.0006, 0.0031, 0.0630, 0.0028, 0.0037, 0.0149, 0.4813, 0.0013, 0.0356, 0.0129 , 0.0014, 0.0306, 0.0665, 0.0018, 0.2727))
chisq
...
cramersV(table,  p= c(0.0078, 0.0006, 0.0031, 0.0630, 0.0028, 0.0037, 0.0149, 0.4813, 0.0013, 0.0356, 0.0129 , 0.0014, 0.0306, 0.0665, 0.0018, 0.2727))
