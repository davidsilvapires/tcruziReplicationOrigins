...
final/TriTrypDB-32_TcruziCLBrenerEsmeraldo-like-gene-DGF.bed input/DGF1.bed
  ln -s /project/carol/dnascent/project/atlas/00-genomeCompartmentComposition/release-32/\
final/TriTrypDB-32_TcruziCLBrenerEsmeraldo-like-gene-MASP.bed input/MASP.bed 
  ln -s /project/carol/dnascent/project/atlas/00-genomeCompartmentComposition/release-32/\
final/TriTrypDB-32_TcruziCLBrenerEsmeraldo-like-gene-RHS.bed input/RHS.bed
  ln -s /project/carol/dnascent/project/atlas/00-genomeCompartmentComposition/release-32/\
final/TriTrypDB-32_TcruziCLBrenerEsmeraldo-like-gene-TS.bed input/TS.bed
  ln -s   /project/carol/dnascent/project/atlas/00-genomeCompartmentComposition/release-32/\
final/TriTrypDB-32_TcruziCLBrenerEsmeraldo-like-gene-mucin.bed  input/MUC.bed

  ln -s /project/carol/dnascent/project/atlas/metaData/tryCru-clb5.gff input/genome.gff 
  ln -s ${GENOME_CHROMSIZE} input/genome-chromSize.csv
