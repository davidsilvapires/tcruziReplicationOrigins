...
# Sorting the bed from Orc1Cdc6 
 sort -k1,1 -k2,2n -k3,3n input/dormantOrigins.bed  > output/dormant-sorted.bed

# Compute Matrix to Variant histone H2BV  co-localization with Orc1Cdc6
computeMatrix scale-regions -S input/Epi2-h2bv.bw \\
  -R output/dormant-sorted.bed \\
  -b 10000 -a 10000 \\
  --verbose \\
  --skipZeros \\
  -o output/matrix-HistoneVariant-h2bv-Dormant.gz \\
  2> log/matrix-HistoneVariant-h2bv-Dormant.err\\
  > log/matrix-HistoneVariant-h2bv-Dormant.out


# Plot Heatmap to h2bv  histones variants
  plotHeatmap -m output/matrix-HistoneVariant-h2bv-Dormant.gz  \\
    --yMin 0 \\
    --yMax 10 \\
    ...
    --outFileSortedRegions output/sortedRegions-H2BV-Dormant-kmeans-10kb.bed \\
    -o output/heatmap-H2BV-Dormant-kmeans-10kb.pdf \\
    2> log/heatmap-H2BV-Dormant-kmeans-10kb.err \\
    > log/heatmap-H2BV-Dormant-kmeans-10kb.out
