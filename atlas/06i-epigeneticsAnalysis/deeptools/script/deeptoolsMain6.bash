...
cat> job/deeptoolsMain6.slurm <<EOI
#!/usr/bin/env bash


# Compute Matrix to Variant histone H2BV  co-localization with Orc1Cdc6 Control
computeMatrix scale-regions -S input/Epi2-h2bv.bw \\
  -R output/radon_sequencesPredominants.bed \\
  -b 10000 -a 10000 \\
  --verbose \\
  -o output/matrix-HistoneVariant-h2bv-Predominant-Control.gz \\
  2> log/matrix-HistoneVariant-h2bv-Predominant-Control.err\\
  > log/matrix-HistoneVariant-h2bv-Predominant-Control.out


# Plot Heatmap to h2bv  histones variants
  plotHeatmap -m output/matrix-HistoneVariant-h2bv-Predominant-Control.gz  \\
    --yMin 0 \\
    --yMax 10 \\
    ...
    --outFileSortedRegions output/sortedRegions-H2BV-Predominant-kmeans-10kb-Control.bed \\
    -o output/heatmap-H2BV-Predominant-Kmeans-10kb-Control.pdf \\
    2> log/heatmap-H2BV-Predominant-Kmeans-10kb-Control.err \\
    > log/heatmap-H2BV-Predominant-Kmeans-10kb-Control.out
...
# Submitting the job to Slurm.
  ...
  --mem ${MEMORY_SIZE} \
  -o log/slurm-%A.out \
  -J deeptoolsMain job/deeptoolsMain6.slurm \
  2> log/sbatch-deeptoolsMain6.err | 
  tee log/sbatch-deeptoolsMain6.out"
