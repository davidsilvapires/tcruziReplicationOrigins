...
#                                  bedtoolsPre                                                    #
#                                                                                                 #
# This script is a required pre-processing step to composing the Dormant origins database.        #
...
ln -s /project/carol/dnascent/project/atlas/metaData/orc1cdc6.bed \
  input/orc1cdc6.bed
ln -s /project/carol/dnascent/project/atlas/01-predominantOrigins/\
bedtools/final/orc1Cdc6ThatMakeupPredominantOrigins.bed \
input/orc1Cdc6ThatMakeUpPredominantOrigins.bed 
ln -s /project/carol/dnascent/project/atlas/02-flexibleOrigins/\
bedtools/final/orc1Cdc6ThatMakeUpFlexibleOrigins.bed \
input/orc1Cdc6ThatMakeUpFlexibleOrigins.bed 
