...
# Making a symbolic link for input data 
     ...
     ln -s /project/carol/dnascent/project/atlas/metaData/dnascentNonSinc3kb.bed \
       input/dnascent.bed
     ln -s /project/carol/dnascent/project/atlas/metaData/tryCru-clb5.gff \
       input/genome5.gff
     ln -s /project/carol/dnascent/orgn/tryCru-clb/tryCru-clb1/gffJulia2/\
final/TriTrypDB-32_TcruziCLBrenerEsmeraldo-like_polycistronAnnotated.gff input/genome.gff
